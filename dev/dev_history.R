...
devtools::create_package("pyroRutils")

devtools::use_readme_rmd()
# Manually edit the readme

devtools::build_readme("pyroRutils")

devtools::use_proprietary_license("Pyrologix LLC")

usethis::use_package("dplyr") # "purrr" "terra" , "stringr",

devtools::check("pyroRutils")

devtools::document("pyroRutils")

devtools::load_all("pyroRutils")


# Manually added roxygen document tags to top of pull_variable_files.R
# Added glue to Imports
